...
WL_EXPORT const struct wl_interface zwlr_foreign_toplevel_manager_v1_interface = {
...
WL_EXPORT const struct wl_interface zwlr_foreign_toplevel_handle_v1_interface = {
